...
errorDescriptions = {
  ...
  64: "Schedule CMD received at mote: {0:02X}{1:02X}" ,
  65: "| slotFrame: {0}, operation: {1}",
  66: "| slotOffset: {0}, channelOffset: {1}",
  67: "| remap to slotOffset: {0}, channelOffset: {1}",
  68: "| cellType: {0}, shared: {1}",
  69: "| bitIndex: {0:08b}{1:08b}",
  70: "| trackID: {0}",
}
